      ...
      <section>
        ...
        <div className="w-10/12 max-w-2xl mx-auto">
          ...
          <article className="timeline-item">
            <h4>Aug - 2020</h4>
            <p>
              Started writing blogs, sharing my knowledge, and giving back to
              the community. Got pretty active on twitter, Connected with a lot
              of like-minded developers, and trying to be an active member of
              the community as much as I can, also made my blog with the help of
          ...
          <article className="timeline-item">
            ...
            <p>
              ...
              designed some basic websites with it that lacked functionality,
              and as I knew python I played around with Django and learned a lot
